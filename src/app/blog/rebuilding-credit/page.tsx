...
export const metadata: import("next").Metadata = {
  title: "Rebuilding Credit: A Practical Step-by-Step Guide | Lakeside Money",
  description:
    ...
    <>
      ...
      <section className="container-x pb-16">
        <div className="max-w-3xl space-y-6 mt-7">
          ...
          <h2 className="text-2xl font-bold text-navy-900 mt-10 mb-3">
            Where Lakeside fits in
          </h2>
          <p className="text-navy-700 leading-relaxed">
            Rebuilding credit does not mean you have to wait for funding when
            you need it. At Lakeside Money, all credit tiers are welcome to
