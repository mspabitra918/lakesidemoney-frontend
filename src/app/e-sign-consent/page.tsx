...
export const metadata: import("next").Metadata = {
  title: "E-Sign Consent Disclosure | Lakeside Money",
  description:
    "Your consent to receive records electronically and to use electronic signatures when applying for a loan with Lakeside Money.",
