...
export const metadata: import("next").Metadata = {
  title: "How It Works — Get Funded in 3 Simple Steps | Lakeside Money",
  description: `Apply in minutes, verify your details, and get funded within ${LOAN.fundingHours} hours. See exactly what you'll need and how an Lakeside personal loan works, step by step.`,
