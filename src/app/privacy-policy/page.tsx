...
export const metadata: import("next").Metadata = {
  title: "Privacy Policy | Lakeside Money",
  description:
    "How Lakeside Money collects, uses, protects, and shares your personal information, including your GLBA and CCPA privacy rights.",
