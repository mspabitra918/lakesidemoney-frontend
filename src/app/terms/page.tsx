...
export const metadata: import("next").Metadata = {
  title: "Terms of Service | Lakeside Money",
  description:
    "The terms and conditions that govern your use of Lakeside Money, including eligibility, loan offer details, disclaimers, and governing law.",
    ...
    <>
      ...
      <section className="container-x pb-20">
        <div className="max-w-3xl space-y-6">
          ...
          <p className="text-navy-700 leading-relaxed">
            Questions? Contact support@lakesidemoney.com or visit our{" "}
            <Link
              href="/contact"
              className="font-semibold text-blue-600 hover:text-blue-700"
            >
