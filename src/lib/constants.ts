...
export const BRAND = {
  name: "Lakeside Money",
  legalName: "Lakeside Money, LLC",
  domain: "lakesidemoney.com",
  tagline: "Modern personal loans, funded in 24 hours.",
  phone: "888-392-2321",
  phoneAlt: "747-200-5220",
  email: "support@lakesidemoney.com",
  address: {
...
> = {
  ...
  DECLINED: {
    ...
    body: "Based on the details provided we're unable to move forward at this time. Thank you for considering Lakeside Money.",
    tone: "bad",
  },
};
